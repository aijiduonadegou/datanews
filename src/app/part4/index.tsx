    ...
    return (
        <div>
            ...
            <div className="cover relative" style={{
                ...
                <div className="paragraph absolute bg-[gray] w-[650px] top-[655px] left-[600px]  "
                     style={{fontSize: '22px', lineHeight: '30px', padding: '20px'}}>
                    吕植，北京大学生命科学学院教授、自然与社会中心执行主任，58岁。
                    “我因为读过达尔文的书，被他探索未知的经历吸引，于是在本科选择了生物学。但我上大学时，北京大学生物系只有实验课，我有点失望。然而，在本科学习的第三年，我很幸运地遇到了一位在野外研究大熊猫的教授。我认为这是一个探索的机会，就联系教授问能不能带着我做研究，就这样开始了我的职业生涯。周围的人都反对，因为他们认为去野外研究动物、到处跑、爬山是典型的‘男人的工作’。但母亲给了我信念，她说，你可以大胆地做出任何决策，但是如果有一天你后悔了，也必须为此负责。我毫不犹豫地告诉她，我不会后悔的。这是真的，我从没后悔过。”   </div>
