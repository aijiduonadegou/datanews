        ...
        <div>
            ...
            <div className="container mx-auto  pt-10 ">
                ...
                <p className={'paragraph'}>
                    <span className={'highLight'}>在培养职业专业能力的大学阶段，STEM专业对女性而言，往往是一道需要花费较大成本负重通行的窄门。</span>
                </p>
                <p className={'paragraph'}>
            ...
            <div className="container mx-auto  pt-10 ">
                <div
                    ...
                    <p className={'paragraph'}>
                        事实就是如此，<span className={'highLight'}>通往科研企业的职业路径早在实习阶段就划出了性别界限。许多用人单位因 “背仪器<br/>爬山等体力活，女生无法胜任”而不招女生。</span>这已是业内心照不宣却从未言明的“行业黑话”。
                    </p>
                    <p className={'paragraph'}>
            ...
            <div className="container mx-auto  pt-10 ">
                ...
                <p className={'paragraph'}>
                    高校的平等招生与企业的歧视招聘之间，看似是一道缝隙，实则是一条无法逾越的鸿沟。面对这种教育与就业无法衔接的断裂，<span className={'highLight'}>地球物理专业的女学生往往只能做出两个方面的选择：一是围绕着升学深造，要么跨考其他理工科专业的研究生，拔高学历的同时换个
                    “名片”进入就业市场；要么继续在本专业深造，</span>硕博毕业后留校任教。<span className={'highLight'}>二是围绕着转岗就业</span>要么考公考编，要么去其他领域工作。
                </p>
                <Row>
                    <Col span={12}>
                        <div
                ...
                <p className={'paragraph'}>
                    ...
                    数据显示，<span className={'highLight'}>工科专业的女生比男生就业率低了15.3％，深造率高了12.6％。</span>
                </span>
                </p>
                ...
                <p className={'paragraph'}>
                    智联招聘数据显示，不同学历水平下，男女就业难度有显著差异。大专阶段女性就业难度系数比男性低0.9%，二者差距最小；硕士阶段为差距最大时期，女性就业难度比男性高6.7%，；到博士阶段二者之间的差距才略微缩小，但女性的就业难度仍比男性高出1.7%。这表明，对STEM女性而言，即便她们继续攻读研究生学位，学历优势在性别结构性不平等面前，并不总是有效的缓冲器。
                    <span className={'highLight'}>研究生学历优势只能相较于大专和本科学历的男性，但是对于同等学历的男性，她们的就业竞争力甚至更弱。</span>

                </p>
                <p className={'paragraph'}>
                    如果不执着于深造，直接就业又如何？麦可思数据显示，<span className={'highLight'}>2020年工科女性毕业半年内就业最多的五大行业中，排名第一的是专业相关度仅为32%却拥有76%就业满意度的教育领域。</span>尽管教育行业薪资较低，涨薪幅度有限，但其晋升比例高达65%，领先多个热门行业。
