        ...
        <div>
            ...
            <div className="container mx-auto  pt-10 ">
                ...
                <p className={'paragraph'}>
                    <span
                        className={'highLight'}>在培养职业专业能力的大学阶段，STEM专业对女性而言，往往是一道需要花费较大成本负重通行的窄门。</span>
                </p>
                <p className={'paragraph'}>
                    中南大学地球物理专业的大三学生小林正陷于这样的困境之中。她曾因兴趣选择了该专业，理应拥有多元出路：考编制入地震局、进入科研企业、继续深造等。然而现实往往是残忍的，有的道路看似光明实则从未畅通。
                </p>
                <p className={'paragraph'}>
                    地球物理专业设有高强度的测绘与勘探实践，因此学生们要背着沉重的仪器去往野外实地考察。清早就进山采样，烈日下计算刨土方量，夜晚扎营深山观测星轨。小林对此并无怨言，她认为爬山和野外作业这样考验身体素质的任务并非女生所不能完成。
                </p>
            </div>
            ...
            <div className="container mx-auto  pt-10 ">
                ...
                <p className={'paragraph'}>
                    最后，小林没有选择考公，而是准备跨考电子信息方向的研究生，以求未来职业的保障性。这样的选择绝非个案。
                ...
                <p className={'paragraph'}>
                    ...
                    <span
                        className={'highLight'}>研究生学历优势只能相较于大专和本科学历的男性，但是对于同等学历的男性，她们的就业竞争力甚至更弱。</span>
