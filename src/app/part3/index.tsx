                    ...
                    </div>
                    {
                        checkStory1 && <div>
                            ...
                            <p className={'paragraph'}>
                                ...
                                className={'highLight'}>她曾经一点点积累起来的职场资本，仿佛一夜归零。</span>谈及此，晴晴很委屈：<span
                                className={'highLight'}>“这和换了一份工作没什么区别。</span>”更令人无奈的是，这种损失几乎没有任何补偿。公司虽发放了育儿津贴，但那点补助根本无法抵消岗位调整所带来的长期影响。甚至，公司内部还流传着一个心照不宣的“三年流失率”潜规则：被调岗的员工，往往在三年内自动流失或被裁撤。
...

                    {
                        checkStory2 && <div>
                            ...
                            <p className={'paragraph'}>
                                ...
                                className={'highLight'}>虽然西西依然在原公司，名义上也未被调岗或裁员，但所有核心项目都已被他人接手，新的项目分配也迟迟没有消息。</span>她每天照常打卡上下班，坐在工位上完成一些边角碎活，却始终无法接入公司真正的技术主线。<span
                                className={'highLight'}>看似还在职场体系内，实则被悄然“雪藏”</span>，没人主动找她沟通新任务，参与的会议也越来越少，她的存在感一点点被稀释，仿佛逐渐从团队中“隐身”了。
                            </p>
                            <p className={'paragraph'}>
