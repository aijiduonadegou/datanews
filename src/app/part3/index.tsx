        ...
        <div>
            ...
            <div className="container mx-auto  pt-10 ">
                <p className={'paragraph'}>
                    <span className={'highLight'}>在婚育之后，STEM女性面临“职业向下流动”的风险，这一威胁并非源于其技术能力的不足，而是生育与技术岗位结构性要求之间的冲突。</span>技术岗位通常具有高度的连续性、协作密集性、人员稳定性以及与经济效益紧密挂钩的特征。然而，女性的生育行为会不可避免地导致工作中断、协作退出以及影响产出，这使得她们与技术岗位原有的运作逻辑不再契合。
                </p>
                <p className={'paragraph'}>
                ...
                <p className={'paragraph'}>
                    <span className={'highLight'}>因此，生产后的STEM女性面临三种情况：转岗下调、不转岗但没有项目做、离职。</span>不管哪种选择，她们的工资和福利待遇都全部下降，让STEM光芒四射的“高薪”特点，已离她们远去，而 <span className={'highLight'}>技术壁垒似乎也不再是庇护她们的“保护伞”。</span>
                </p>
                ...
                <div className={checkStory ? '' : 'flex'}>
                    ...
                    </div>
                    {
                        checkStory && <div>
                            ...
                            <p className={'paragraph'}>
                                晴晴感觉自己像从头到脚被凉水浇透了。课程审核的岗位本身基础工资就低，同时不再涉及授课，没有建立口碑的机会，也自然意味着没有办法获得绩效奖金。<span className={'highLight'}>她曾经一点点积累起来的职场资本，仿佛一夜归零。</span>谈及此，晴晴很委屈：<span className={'highLight'}>“这和换了一份工作没什么区别。</span>这”更令人无奈的是，这种损失几乎没有任何补偿。公司虽发放了育儿津贴，但那点补助根本无法抵消岗位调整所带来的长期影响。甚至，公司内部还流传着一个心照不宣的“三年流失率”潜规则：被调岗的员工，往往在三年内自动流失或被裁撤。
...

                    {
                        checkStory && <div>
                            ...
                            <p className={'paragraph'}>
                                在西西坚决不离职的坚持下，领导没有再劝说，然而她的处境却十分尴尬。<span className={'highLight'}>虽然西西依然在原公司，名义上也未被调岗或裁员，但所有核心项目都已被他人接手，新的项目分配也迟迟没有消息。</span>她每天照常打卡上下班，坐在工位上完成一些边角碎活，却始终无法接入公司真正的技术主线。<span className={'highLight'}>看似还在职场体系内，实则被悄然“雪藏”</span>，没人主动找她沟通新任务，参与的会议也越来越少，她的存在感一点点被稀释，仿佛逐渐从团队中“隐身”了。
                            </p>
                            <p className={'paragraph'}>
...

                    {
                        checkStory && <div>
                            ...
                            <p className={'paragraph'}>
                                ...
                                <span className={'highLight'}>曾经拼命学代码、通宵debug，想要在技术行业站稳脚跟的努力早就成了一场空。</span>如今的她，消磨在家庭和工作的拉锯中，也早已不再想象如果能回到过去那个岗位，人生还会是怎样的光景。
                            </p>
