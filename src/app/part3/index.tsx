                ...
                <div className={checkStory ? '' : 'flex'}>
                    ...
                    </div>
                    {
                        checkStory && <div>
                            ...
                            <p className={'paragraph'}>
                                晴晴感觉自己像从头到脚被凉水浇透了。课程审核的岗位本身基础工资就低，同时不再涉及授课，没有建立口碑的机会，也自然意味着没有办法获得绩效奖金。<span className={'highLight'}>她曾经一点点积累起来的职场资本，仿佛一夜归零。</span>谈及此，晴晴很委屈：<span className={'highLight'}>“这和换了一份工作没什么区别。</span>”更令人无奈的是，这种损失几乎没有任何补偿。公司虽发放了育儿津贴，但那点补助根本无法抵消岗位调整所带来的长期影响。甚至，公司内部还流传着一个心照不宣的“三年流失率”潜规则：被调岗的员工，往往在三年内自动流失或被裁撤。
